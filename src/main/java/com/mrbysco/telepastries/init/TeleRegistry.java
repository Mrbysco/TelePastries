...
//   public static final RegistryObject<Block> HUNTING_DIMENSION_CAKE = BLOCKS.register("hunting_dimension_cake", () -> new BlockHuntingDimensionCake("hunting_dimension_cake"));
   ...
   public static final RegistryObject<Item> NETHER_CAKE_ITEM = ITEMS.register("nether_cake", () -> new BlockItem(NETHER_CAKE.get(), new Item.Properties().tab(TeleTab.TELE_TAB)));
   public static final RegistryObject<Item> END_CAKE_ITEM = ITEMS.register("end_cake", () -> new BlockItem(END_CAKE.get(), new Item.Properties().tab(TeleTab.TELE_TAB)));
   public static final RegistryObject<Item> OVERWORLD_CAKE_ITEM = ITEMS.register("overworld_cake", () -> new BlockItem(OVERWORLD_CAKE.get(), new Item.Properties().tab(TeleTab.TELE_TAB)));

   public static final RegistryObject<Item> TWILIGHT_CAKE_ITEM = ITEMS.register("twilight_cake", () -> new BlockItem(TWILIGHT_CAKE.get(), new Item.Properties().tab(TeleTab.TELE_TAB)));
   public static final RegistryObject<Item> LOST_CITY_CAKE_ITEM = ITEMS.register("lost_city_cake", () -> new BlockItem(LOST_CITY_CAKE.get(), new Item.Properties().tab(TeleTab.TELE_TAB)));
