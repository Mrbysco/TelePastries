...
public class BlockCustomCake3 extends BlockCakeBase {
	...
	public MutableComponent getName() {
		return new TranslatableComponent(this.getDescriptionId(), TeleConfig.COMMON.customCake3Name.get());
	}
	...
	public ResourceKey<Level> getCakeWorld() {
		return ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(TeleConfig.COMMON.customCake3Dimension.get()));
	}
